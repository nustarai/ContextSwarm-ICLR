...
class AgentRecoveryTests(unittest.TestCase):
    ...
    def test_inner_pi_timeout_is_recoverable_while_horizon_remains(self) -> None:
        attempts: list[int] = []
    ...
    def test_classifier_excludes_success_cancellation_and_fixed_horizon(self) -> None:
        ...
        cases = (
            ...
            ("inner timeout", _result(124, timed_out=True), 10.0, None, True),
    ...
    def test_zero_delay_rechecks_cancellation_before_relaunch(self) -> None:
        ...
        self.assertIn(
            exhausted[0]["reason"],
            {"cancelled_or_horizon_or_nonfailure", "cancelled_before_relaunch"},
        )
