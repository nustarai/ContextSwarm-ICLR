# Verina Formal Task: `verina_advanced_48`
...
- Baseline file: `baseline/verina_advanced_48.lean`.
- Benchmark source: `Goedel-Code-Prover/benchmark/verina_bench.json`
- Original problem id: `verina/verina_advanced_48.lean`
- Subset: `advanced`
- Namespace: `verina_advanced_48`
- Target theorem: `mergeSort_spec_satisfied`

## Contract Scope

This task proves only the checked Lean functional contract: the result of the
included implementation is sorted and is a permutation of the input. The
included implementation is insertion sort, exactly as the upstream `task.lean`
comment states. A proof does **not** certify that the implementation is merge
sort or divide-and-conquer. Those algorithm-identity claims from the upstream
natural-language description are explicitly excluded from this benchmark.
