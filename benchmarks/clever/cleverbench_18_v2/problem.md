# Clever Formal Task: `cleverbench_18_v2`
...
- Baseline file: `baseline/cleverbench_18_v2.lean`.
...
- Problem id: `cleverbench_18_v2`
- Namespace: `cleverbench_18_v2`
- Target theorem: `implementation_postcond_satisfied`

This is semantics revision 2 and supersedes `cleverbench_18`. It ports the
empty-substring fix made upstream in Clever commit
`c462ac1e1840f04fa48cca4f4dfbaf527d1df362`: an empty substring occurs
`string.length` times. Results for the old problem id are not comparable.
