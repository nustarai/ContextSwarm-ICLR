# Clever Formal Task: `cleverbench_89_v2`
...
- Baseline file: `baseline/cleverbench_89_v2.lean`.
...
- Problem id: `cleverbench_89_v2`
- Namespace: `cleverbench_89_v2`
- Target theorem: `implementation_postcond_satisfied`

This is semantics revision 2 and supersedes `cleverbench_89`. The old
`some r` contract did not require `r` to occur in the input and therefore
admitted invented values. Revision 2 adds that membership condition while
retaining the upstream definition of the second distinct minimum. Results
for the old problem id are not comparable.
