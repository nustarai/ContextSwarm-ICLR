# Clever Formal Task: `cleverbench_102_v2`
...
- Baseline file: `baseline/cleverbench_102_v2.lean`.
...
- Problem id: `cleverbench_102_v2`
- Namespace: `cleverbench_102_v2`
- Target theorem: `implementation_postcond_satisfied`

This is contract-scope revision 2 and supersedes `cleverbench_102`. It
deliberately specifies the behavior implemented and tested by current
Clever `problem_103`: encode the `Nat.div` (floor) average in binary. The
stale upstream prose saying “nearest integer” is not part of this task's
claim. Upstream commit `019a99821b0b1287f265287fb5e5f855dcf627e0`
likewise changed a test expectation from nearest rounding to floor. Results
for the old problem id are not compared with revision 2.
