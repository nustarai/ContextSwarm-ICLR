        # Clever Formal Task: `cleverbench_150`
        ...
        - Baseline file: `baseline/cleverbench_150.lean`.
...
- Benchmark sha256: `f9c40ba9c1cff83452f0abdd9a23b023b808b7a74f5fe8f0df414e4cf972eb42`
        ...
        `problem_152`, not a byte-identical official task. The official theorem
        quantifies over unequal-length inputs but unconditionally requires equal
        lengths. This version makes equal-length lists with nonzero rational
        denominators the checked domain and treats other encodings as out of
        domain. The repair predates ContextSwarm inclusion and therefore retains
